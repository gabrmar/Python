...
from Módulos.ES_mánager import registrar,validar_registro,iniciar_sesión,pos_inicio
...
if teclado == "2":
    ...
    validar_registro()
    # Esta parte de abaajo se puede optimizar de otra forma 
    pos_inicio(user) #Hay un problema con el ocultar de la contraseña cuando los datos no son correctos (luego de un N)
    #-----Acá viene la parte del menú donde se pregunta por reproducir, buscar otra canción o añadir a una lista de reproducción
if teclado == "3":
