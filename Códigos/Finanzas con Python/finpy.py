...
def formato(numero): 
    ...
    assert (numero >= 0), "Esta función no trabaja con números menores a 0"

    if numero > 0 and numero < 1:
        numero = round(numero,6) #Redondeando cifras decimales
        numero = str(numero) #Transformanndo el número a string
        salida = numero
        return salida  #*********Falta probar esta sub sección de código****
